...
nomes_arqs_forms_u.append( [ 'Repetição Condicional', 'Repetição Condicional Aplicações', 'Introdução ao P5JS', 'Mouse, teclado e ponto dentro de um retângulo', 'Repetição Condicional e Introdução a Laço Contado', 'Repetição Contada','Sensação de Aprendizado II'] )
...
colunas_u.append( [ 'rep','rep_ap','intro_p5js', 'mouse','rep_cont_1','rep_cont_2','sens_ap_2'] )
